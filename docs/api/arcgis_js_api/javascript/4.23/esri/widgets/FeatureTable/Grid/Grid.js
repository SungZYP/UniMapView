...
function(eb,x,$d,fb,ae,bc,gb,H,og,pg,be,L,ce,de,ee,fe,ge,qg,ja){function cc(b){requestAnimationFrame(function(){dc?dc(b):(hb||(hb=new Promise(a=>{ib=a}),"complete"===document.readyState?ib():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&ib()})),hb.then(function(){b&&b()}))})}function jb(b,a){for(let c in a)null===c?b.style.removeProperty(c):b.style.setProperty(c,a[c])}function ec(b,a){return(b=window.getComputedStyle(b).getPropertyValue(a))?b.trim():""}function fc(b){kb=
...
C.head.appendChild(C.base),C.anchor=C.createElement("a"),C.body.appendChild(C.anchor));C.base.href=a;C.anchor.href=b;return C.anchor.href||b}function lb(b,a){return b.replace(ie,function(c,d,e,f){return d+"'"+ka(e.replace(/["']/g,""),a)+"'"+f})}function mb(b){return b.substring(0,b.lastIndexOf("/")+1)}function gc(b){b=lb((b.body?b.body:b).textContent,b.baseURI);const a=document.createElement("style");a.textContent=b;return a}function je(b){b=b.trim().split(/\s+/);const a=[];for(let c=0;c<b.length;c++)a.push(...ke(b[c]));
return a}function ke(b){const a=M.import(b);if(!a)return console.warn("Could not find style data in module named",b),[];if(void 0===a._styles){b=[];b.push(...nb(a));const c=a.querySelector("template");c&&b.push(...ob(c,a.assetpath));a._styles=b}return a._styles}function ob(b,a){if(!b._styles){const c=[],d=b.content.querySelectorAll("style");for(let e=0;e<d.length;e++){let f=d[e],g=f.getAttribute("include");g&&c.push(...je(g).filter(function(h,k,l){return l.indexOf(h)===k}));a&&(f.textContent=lb(f.textContent,
a));c.push(f)}b._styles=c}return b._styles}function le(b){return(b=M.import(b))?nb(b):[]}function nb(b){const a=[];b=b.querySelectorAll("link[rel\x3dimport][type~\x3dcss]");for(let d=0;d<b.length;d++){var c=b[d];if(c.import){const e=c.import;if((c=c.hasAttribute("shady-unscoped"))&&!e._unscopedStyle){const f=gc(e);f.setAttribute("shady-unscoped","");e._unscopedStyle=f}else e._style||(e._style=gc(e));a.push(c?e._unscopedStyle:e._style)}}return a}function I(b){let a=b.indexOf(".");return-1===a?b:b.slice(0,
a)}function la(b){if(Array.isArray(b)){let a=[];for(let c=0;c<b.length;c++){let d=b[c].toString().split(".");for(let e=0;e<d.length;e++)a.push(d[e])}return a.join(".")}return b}function hc(b){return Array.isArray(b)?la(b).split("."):b.toString().split(".")}function A(b,a,c){a=hc(a);for(let d=0;d<a.length;d++){if(!b)return;b=b[a[d]]}c&&(c.path=a.join("."));return b}function ic(b,a,c){let d=hc(a),e=d[d.length-1];if(1<d.length){for(a=0;a<d.length-1;a++)if(b=b[d[a]],!b)return;b[e]=c}else b[a]=c;return d.join(".")}
function jc(b){return Ka[b]||(Ka[b]=0>b.indexOf("-")?b:b.replace(me,a=>a[1].toUpperCase()))}function La(b){return Ka[b]||(Ka[b]=b.replace(ne,"-$1").toLowerCase())}function kc(b,a){let c=a.parentInfo&&kc(b,a.parentInfo);if(c)for(let d=c.firstChild,e=0;d;d=d.nextSibling){if(a.parentIndex===e++)return d}else return b}function oe(b,a,c){b=b._methodHost||b;return function(d){if(b[c])b[c](d,d.detail);else console.warn("listener method `"+c+"` not defined")}}function pb(b,a,c){let d=b[a];if(!d)d=b[a]={};
else if(!b.hasOwnProperty(a)&&(d=b[a]=Object.create(b[a]),c))for(let e in d)for(b=d[e],a=d[e]=Array(b.length),c=0;c<b.length;c++)a[c]=b[c];return d}function ma(b,a,c,d,e,f){if(a){let h=!1;const k=na++;for(let l in c){var g=e?I(l):l;if(g=a[g])for(let m=0,n=g.length,p;m<n&&(p=g[m]);m++)p.info&&p.info.lastRun===k||e&&!qb(l,p.trigger)||(p.info&&(p.info.lastRun=k),p.fn(b,l,c,d,p.info,e,f),h=!0)}return h}return!1}function qb(b,a){if(a){let c=a.name;return c==b||!(!a.structured||0!==c.indexOf(b+"."))||!(!a.wildcard||
0!==b.indexOf(c+"."))}return!0}function lc(b,a,c,d,e){a="string"===typeof e.method?b[e.method]:e.method;c=e.property;a?a.call(b,b.__data[c],d[c]):e.dynamicFn||console.warn("observer method `"+e.method+"` not defined")}function mc(b,a,c,d){c={value:c,queueProperty:!0};d&&(c.path=d);q(b).dispatchEvent(new CustomEvent(a,{detail:c}))}function pe(b,a,c,d,e,f){f=(d=(f?I(a):a)!=a?a:null)?A(b,d):b.__data[a];d&&void 0===f&&(f=c[a]);mc(b,e.eventName,f,d)}function qe(b,a,c,d,e){c=b.__data[a];Ma&&(c=Ma(c,e.attrName,
...
for(let g=0,h;g<a.args.length&&(h=a.args[g]);g++)h.literal||b._addPropertyEffect(h.rootProperty,c,{fn:d,info:e,trigger:h});f&&b._addPropertyEffect(a.methodName,c,{fn:d,info:e});return e}function rb(b,a,c,d,e){d=b._methodHost||b;let f=d[e.methodName];if(f)return b=b._marshalArgs(e.args,a,c),b===oa?oa:f.apply(d,b);e.dynamicFn||console.warn("method `"+e.methodName+"` not defined")}function qc(b){let a="";for(let c=0;c<b.length;c++)a+=b[c].literal||"";return a}function tb(b){var a=b.match(/([^\s]+?)\(([\s\S]*)\)/);
return a?(b={methodName:a[1],static:!0,args:ve},a[2].trim()?(a=a[2].replace(/\\,/g,"\x26comma;").split(","),we(a,b)):b):null}function we(b,a){a.args=b.map(function(c){c=oc(c);c.literal||(a.static=!1);return c},this);return a}function oc(b){b=b.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1");let a={name:b,value:"",literal:!1},c=b[0];"-"===c&&(c=b[1]);"0"<=c&&"9">=c&&(c="#");switch(c){case "'":case '"':a.value=b.slice(1,-1);a.literal=!0;break;case "#":a.value=Number(b),a.literal=!0}a.literal||
(a.rootProperty=I(b),a.structured=0<=b.indexOf("."),a.structured&&(a.wildcard=".*"==b.slice(-2),a.wildcard&&(a.name=b.slice(0,-2))));return a}function rc(b,a,c){b=A(b,c);void 0===b&&(b=a[c]);return b}function sc(b,a,c,d){d={indexSplices:d};ub&&!b._overrideLegacyUndefined&&(a.splices=d);b.notifyPath(c+".splices",d);b.notifyPath(c+".length",a.length);ub&&!b._overrideLegacyUndefined&&(d.indexSplices=[])}function pa(b,a,c,d,e,f){sc(b,a,c,[{index:d,addedCount:e,removed:f,object:a,type:"splice"}])}function xe(b){return b[0].toUpperCase()+
b.substring(1)}function tc(b){if(!(-1<Na.indexOf(b))&&"touchend"!==b&&vb&&wb&&ye)return{passive:!0}}function uc(b){let a=vc?["click"]:Na;for(let c=0,d;c<a.length;c++)d=a[c],b?(xb.length=0,document.addEventListener(d,wc,!0)):document.removeEventListener(d,wc,!0)}function W(b){var a=b.type;return-1<Na.indexOf(a)?"mousemove"===a?(a=void 0===b.buttons?1:b.buttons,b instanceof window.MouseEvent&&!ze&&(a=Ae[b.which]||0),!!(a&1)):0===(void 0===b.button?0:b.button):!1}function Be(b){if("click"===b.type){if(0===
b.detail)return!0;var a=N(b);if(!a.nodeType||a.nodeType!==Node.ELEMENT_NODE)return!0;a=a.getBoundingClientRect();let c=b.pageX;b=b.pageY;return!(c>=a.left&&c<=a.right&&b>=a.top&&b<=a.bottom)}return!1}function xc(b,a,c){b.movefn=a;b.upfn=c;document.addEventListener("mousemove",a);document.addEventListener("mouseup",c)}function Z(b){document.removeEventListener("mousemove",b.movefn);document.removeEventListener("mouseup",b.upfn);b.movefn=null;b.upfn=null}function N(b){const a=Oa(b);return 0<a.length?
a[0]:b.target}function yc(b){let a=b.type;var c=b.currentTarget.__polymerGestures;if(c&&(c=c[a])){if(!b.__polymerGesturesHandled&&(b.__polymerGesturesHandled={},"touch"===a.slice(0,5))){var d=b.changedTouches[0];"touchstart"===a&&1===b.touches.length&&(y.touch.id=d.identifier);if(y.touch.id!==d.identifier)return;if(!vb&&("touchstart"===a||"touchmove"===a)){d=b.changedTouches[0];var e=b.type;if("touchstart"===e)y.touch.x=d.clientX,y.touch.y=d.clientY,y.touch.scrollDecided=!1;else if("touchmove"===
...
k.reset&&k.reset();for(let h=0,k;h<X.length;h++)k=X[h],c[k.name]&&!d[k.name]&&(d[k.name]=!0,k[a](b))}}}function yb(b,a,c){if(qa[a]){{let d=qa[a],e=d.deps,f=d.name,g=b.__polymerGestures;g||(b.__polymerGestures=g={});for(let h=0,k,l;h<e.length;h++)k=e[h],vc&&-1<Na.indexOf(k)&&"click"!==k||((l=g[k])||(g[k]=l={_count:0}),0===l._count&&b.addEventListener(k,yc,tc(k)),l[f]=(l[f]||0)+1,l._count=(l._count||0)+1);b.addEventListener(a,c);d.touchAction&&zc(b,d.touchAction)}return!0}return!1}function zb(b){X.push(b);
for(let a=0;a<b.emits.length;a++)qa[b.emits[a]]=b}function zc(b,a){vb&&b instanceof HTMLElement&&F.run(()=>{b.style.touchAction=a});b.__polymerGesturesTouchAction=a}function Ab(b,a,c){a=new Event(a,{bubbles:!0,cancelable:!0,composed:!0});a.detail=c;q(b).dispatchEvent(a);a.defaultPrevented&&(b=c.preventer||c.sourceEvent)&&b.preventDefault&&b.preventDefault()}function Pa(b){a:{for(let a=0,c;a<X.length;a++){c=X[a];for(let d=0,e;d<c.emits.length;d++)if(e=c.emits[d],e===b){b=c;break a}}b=null}b.info&&
(b.info.prevent=!0)}function ra(b,a,c,d){a&&Ab(a,b,{x:c.clientX,y:c.clientY,sourceEvent:c,preventer:d,prevent:function(e){return Pa(e)}})}function Ac(b,a,c){if(b.prevent)return!1;if(b.started)return!0;c=Math.abs(b.y-c);return 5<=Math.abs(b.x-a)||5<=c}function Bb(b,a,c){if(a){var d=b.moves[b.moves.length-2],e=b.moves[b.moves.length-1],f=e.x-b.x,g=e.y-b.y,h=0;if(d){var k=e.x-d.x;h=e.y-d.y}Ab(a,"track",{state:b.state,x:c.clientX,y:c.clientY,dx:f,dy:g,ddx:k,ddy:h,sourceEvent:c,hover:function(){{var l=
c.clientX;var m=c.clientY;let n=document.elementFromPoint(l,m),p=n;for(;p&&p.shadowRoot&&!window.ShadyDOM;){let r=p;p=p.shadowRoot.elementFromPoint(l,m);if(r===p)break;p&&(n=p)}l=n}return l}})}}function Bc(b,a,c){let d=Math.abs(a.clientX-b.x),e=Math.abs(a.clientY-b.y),f=N(c||a);!f||Ce[f.localName]&&f.hasAttribute("disabled")||!(isNaN(d)||isNaN(e)||25>=d&&25>=e||Be(a))||b.prevent||Ab(f,"tap",{x:a.clientX,y:a.clientY,sourceEvent:a,preventer:c})}function De(){return Cc(function(){return!0})}function Ee(){return Qa&&
0<Object.keys(Qa).map(b=>Qa[b]).filter(b=>b.productionMode).length?!0:!1}function Cc(b,a){if("function"===typeof b){var c=Fe.exec(b.toString());if(c)try{b=new Function(c[1])}catch(d){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",d)}return b(a)}}function Ge(){}function Dc(){Ra=!0;requestAnimationFrame(function(){Ra=!1;He(Ec);setTimeout(function(){var b=Fc;for(let a=0,c=b.length;a<c;a++)Gc(b.shift())})})}function He(b){for(;b.length;)Gc(b.shift())}function Gc(b){const a=b[0],
c=b[1];b=b[2];try{c.apply(a,b)}catch(d){setTimeout(()=>{throw d;})}}function Ie(b,a,c){Ra||Dc();Ec.push([b,a,c])}function Je(b,a,c){Ra||Dc();Fc.push([b,a,c])}function Hc(b){b=b.replace(J.comments,"").replace(J.port,"");{var a=b;let c=new Ic;c.start=0;c.end=a.length;let d=c;for(let e=0,f=a.length;e<f;e++)if("{"===a[e]){d.rules||(d.rules=[]);let g=d,h=g.rules[g.rules.length-1]||null;d=new Ic;d.start=e+1;d.parent=g;d.previous=h;g.rules.push(d)}else"}"===a[e]&&(d.end=e+1,d=d.parent||c);a=c}return Jc(a,
b)}function Jc(b,a){var c=a.substring(b.start,b.end-1);b.parsedCssText=b.cssText=c.trim();b.parent&&(c=a.substring(b.previous?b.previous.end:b.parent.start,b.start-1),c=Ke(c),c=c.replace(J.multipleSpaces," "),c=c.substring(c.lastIndexOf(";")+1),c=b.parsedSelector=b.selector=c.trim(),b.atRule=0===c.indexOf("@"),b.atRule?0===c.indexOf("@media")?b.type=O.MEDIA_RULE:c.match(J.keyframesRule)&&(b.type=O.KEYFRAMES_RULE,b.keyframesName=b.selector.split(J.multipleSpaces).pop()):0===c.indexOf("--")?b.type=
O.MIXIN_RULE:b.type=O.STYLE_RULE);if(c=b.rules)for(let d=0,e=c.length,f;d<e&&(f=c[d]);d++)Jc(f,a);return b}function Ke(b){return b.replace(/\\([0-9a-f]{1,6})\s/gi,function(a,c){a=c;for(c=6-a.length;c--;)a="0"+a;return"\\"+a})}function Kc(b,a,c=""){let d="";if(b.cssText||b.rules){let f=b.rules;var e;if(e=f)e=f[0],e=!!e&&!!e.selector&&0===e.selector.indexOf("--"),e=!e;if(e)for(let g=0,h=f.length,k;g<h&&(k=f[g]);g++)d=Kc(k,a,d);else a?a=b.cssText:(a=b.cssText,a=a.replace(J.customProp,"").replace(J.mixinProp,
""),a=a.replace(J.mixinApply,"").replace(J.varApply,"")),(d=a.trim())&&(d="  "+d+"\n")}d&&(b.selector&&(c+=b.selector+" {\n"),c+=d,b.selector&&(c+="}\n\n"));return c}function Cb(b,a){if(!b)return"";"string"===typeof b&&(b=Hc(b));a&&sa(b,a);return Kc(b,Db)}function Lc(b){!b.__cssRules&&b.textContent&&(b.__cssRules=Hc(b.textContent));return b.__cssRules||null}function sa(b,a,c,d){if(b){var e=!1,f=b.type;if(d&&f===O.MEDIA_RULE){let g=b.selector.match(Le);g&&(window.matchMedia(g[1]).matches||(e=!0))}f===
O.STYLE_RULE?a(b):c&&f===O.KEYFRAMES_RULE?c(b):f===O.MIXIN_RULE&&(e=!0);if((b=b.rules)&&!e)for(let g=0,h=b.length,k;g<h&&(k=b[g]);g++)sa(k,a,c,d)}}function Mc(b,a){var c=b.indexOf("var(");if(-1===c)return a(b,"","","");a:{var d=0;for(let g=c+3,h=b.length;g<h;g++)if("("===b[g])d++;else if(")"===b[g]&&0===--d){d=g;break a}d=-1}var e=d;d=b.substring(c+4,e);c=b.substring(0,c);b=Mc(b.substring(e+1),a);let f=d.indexOf(",");if(-1===f)return a(c,d.trim(),"",b);e=d.substring(0,f).trim();d=d.substring(f+1).trim();
return a(c,e,d,b)}function Nc(b){if(void 0!==ta)return ta;if(void 0===b.__cssBuild){var a=b.getAttribute("css-build");if(a)b.__cssBuild=a;else{a:{a="template"===b.localName?b.content.firstChild:b.firstChild;if(a instanceof Comment&&(a=a.textContent.trim().split(":"),"css-build"===a[0])){a=a[1];break a}a=""}if(""!==a){{const c="template"===b.localName?b.content.firstChild:b.firstChild;c.parentNode.removeChild(c)}}b.__cssBuild=a}}return b.__cssBuild||""}function Me(b){if(b=Eb[b])b._applyShimCurrentVersion=
b._applyShimCurrentVersion||0,b._applyShimValidatingVersion=b._applyShimValidatingVersion||0,b._applyShimNextVersion=(b._applyShimNextVersion||0)+1}function Oc(b){return b._applyShimCurrentVersion===b._applyShimNextVersion}function Ne(b){b._applyShimValidatingVersion=b._applyShimNextVersion;b._validating||(b._validating=!0,Oe.then(function(){b._applyShimCurrentVersion=b._applyShimNextVersion;b._validating=!1}))}function Pc(){ua=document.documentElement.getAttribute("dir");ua=document.documentElement.getAttribute("dir");
for(let a=0;a<va.length;a++){var b=va[a];b.__autoDirOptOut||b.setAttribute("dir",ua)}}function Qc(){document.body.removeAttribute("unresolved")}function wa(b,a,c){return{index:b,removed:a,addedCount:c}}function Rc(b,a,c,d,e,f){var g=0,h=0,k=Math.min(c-a,f-e);if(0==a&&0==e)a:{for(g=0;g<k;g++)if(b[g]!==d[g])break a;g=k}if(c==b.length&&f==d.length){h=k-g;k=b.length;for(var l=d.length,m=0;m<h&&Pe(b[--k],d[--l]);)m++;h=m}a+=g;e+=g;c-=h;f-=h;if(0==c-a&&0==f-e)return[];if(a==c){for(b=wa(a,[],0);e<f;)b.removed.push(d[e++]);
...
arguments)}}}function Sc(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},configurable:!0})}}function Re(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},set:function(e){this.node[d]=e},configurable:!0})}}function Se(b,a=!1){if(!Fb||!Tc||!Fb.handlesDynamicScoping)return null;const c=Tc.ScopingShim;if(!c)return null;const d=c.scopeForNode(b),e=q(b).getRootNode(),f=g=>{if(q(g).getRootNode()===
e){var h=Array.from(Fb.nativeMethods.querySelectorAll.call(g,"*"));h.push(g);for(g=0;g<h.length;g++){const l=h[g];var k=e;q(l).getRootNode()===k&&(k=c.currentScopeForNode(l),k!==d&&(""!==k&&c.unscopeNode(l,k),c.scopeNode(l,d)))}}};f(b);return a?(a=new MutationObserver(g=>{for(let h=0;h<g.length;h++){const k=g[h];for(let l=0;l<k.addedNodes.length;l++){const m=k.addedNodes[l];m.nodeType===Node.ELEMENT_NODE&&f(m)}}}),a.observe(b,{childList:!0,subtree:!0}),a):null}function Uc(b,a,c,d){{const e=a._noAccessors,
...
for(let l=0;l<k.length;l++)Uc(h,k[l],e,Ve)}Uc(h,b,e,Xc)};xa||g(f.prototype);f.generatedFrom=b;return f}function Gb(b,a,c,d,e){let f;e&&(f="object"===typeof c&&null!==c)&&(d=b.__dataTemp[a]);d=d!==c&&(d===d||c===c);f&&d&&(b.__dataTemp[a]=c);return d}function Hb(){return Ib}function Yc(b,a){for(let c=0;c<a.length;c++){let d=a[c];if(!!b!=!!d.__hideTemplateChildren__)if(d.nodeType===Node.TEXT_NODE)b?(d.__polymerTextContent__=d.textContent,d.textContent=""):d.textContent=d.__polymerTextContent__;else if("slot"===
d.localName)if(b)d.__polymerReplaced__=document.createComment("hidden-slot"),q(q(d).parentNode).replaceChild(d.__polymerReplaced__,d);else{const e=d.__polymerReplaced__;e&&q(q(e).parentNode).replaceChild(d,e)}else d.style&&(b?(d.__polymerDisplay__=d.style.display,d.style.display="none"):d.style.display=d.__polymerDisplay__);d.__hideTemplateChildren__=b;d._showHideChildren&&d._showHideChildren(b)}}function Zc(b){return(b=b.__dataHost)&&b._methodHost||b}function We(b,a){return function(c,d,e){a.call(c.__templatizeOwner,
d.substring(6),e[d])}}function Xe(b,a){return function(c,d,e){a.call(c.__templatizeOwner,c,d,e[d])}}function Ye(){return function(b,a,c){b.__dataHost._setPendingPropertyOrPath("_host_"+a,c[a],!0,!0)}}function ya(b,a,c){if(ba&&!Zc(b))throw Error("strictTemplatePolicy: template owner not trusted");c=c||{};if(b.__templatizeOwner)throw Error("A \x3ctemplate\x3e can only be templatized once");b.__templatizeOwner=a;let d=(a?a.constructor:Jb)._parseTemplate(b);var e=d.templatizeInstanceClass;if(!e){e=c;
var f=e.mutableData?Ze:Jb;ya.mixin&&(f=ya.mixin(f));var g=class extends f{};g.prototype.__templatizeOptions=e;g.prototype._bindTemplate(b);f=g;var h=d.hostProps||{};for(var k in e.instanceProps){delete h[k];var l=e.notifyInstanceProp;l&&f.prototype._addPropertyEffect(k,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Xe(k,l)})}if(e.forwardHostProp&&b.__dataHost)for(var m in h)d.hasHostProps||(d.hasHostProps=!0),f.prototype._addPropertyEffect(m,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Ye()});e=g;d.templatizeInstanceClass=
e}k=Zc(b);f=c;if((g=f.forwardHostProp)&&d.hasHostProps){c="template"==b.localName;m=d.templatizeTemplateClass;if(!m){if(c){m=f.mutableData?$e:$c;class u extends m{}m=d.templatizeTemplateClass=u}else{m=b.constructor;class u extends m{}m=d.templatizeTemplateClass=u}h=d.hostProps;for(var n in h)m.prototype._addPropertyEffect("_host_"+n,m.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:We(n,g)}),m.prototype._createNotifyingProperty("_host_"+n);if(ad&&k){n=k.constructor._properties;({propertyEffects:g}=
d);({instanceProps:f}=f);for(var p in g)if(!(n[p]||f&&f[p]))for(h=g[p],l=0;l<h.length;l++){const {part:u}=h[l].info;if(!u.signature||!u.signature.static){console.warn(`Property '${p}' used in template but not `+"declared in 'properties'; attribute will not be observed.");break}}}}b.__dataProto&&Object.assign(b.__data,b.__dataProto);if(c){var r=m;Ib=b;Object.setPrototypeOf(b,r.prototype);new r;Ib=null;b.__dataTemp={};b.__dataPending=null;b.__dataOld=null;b._enableProperties()}else for(r in Object.setPrototypeOf(b,
m.prototype),p=d.hostProps,p)r="_host_"+r,r in b&&(p=b[r],delete b[r],b.__data[r]=p)}r=class extends e{};r.prototype._methodHost=k;r.prototype.__dataHost=b;r.prototype.__templatizeOwner=a;r.prototype.__hostProps=d.hostProps;return r}function Kb(){if(xa&&!Lb){if(!bd){bd=!0;const b=document.createElement("style");b.textContent="dom-bind,dom-if,dom-repeat{display:none;}";document.head.appendChild(b)}return!0}return!1}class af extends HTMLElement{static get version(){return"1.6.1"}}customElements.define("vaadin-lumo-styles",
af);let hb=null,dc=window.HTMLImports&&window.HTMLImports.whenReady||null,ib,Sa=null,za=null;class P{constructor(){this.customStyles=[];this.enqueued=!1;cc(()=>{window.ShadyCSS.flushCustomStyles&&window.ShadyCSS.flushCustomStyles()})}enqueueDocumentValidation(){!this.enqueued&&za&&(this.enqueued=!0,cc(za))}addCustomStyle(b){b.__seenByShadyCSS||(b.__seenByShadyCSS=!0,this.customStyles.push(b),this.enqueueDocumentValidation())}getStyleForCustomStyle(b){return b.__shadyCSSCachedStyle?b.__shadyCSSCachedStyle:
b.getStyle?b.getStyle():b}processStyles(){const b=this.customStyles;for(let c=0;c<b.length;c++){const d=b[c];if(!d.__shadyCSSCachedStyle){var a=this.getStyleForCustomStyle(d);a&&(a=a.__appliedElement||a,Sa&&Sa(a),d.__shadyCSSCachedStyle=a)}}return b}}P.prototype.addCustomStyle=P.prototype.addCustomStyle;P.prototype.getStyleForCustomStyle=P.prototype.getStyleForCustomStyle;P.prototype.processStyles=P.prototype.processStyles;Object.defineProperties(P.prototype,{transformCallback:{get(){return Sa},set(b){Sa=
b}},validateCallback:{get(){return za},set(b){let a=!1;za||(a=!0);za=b;a&&this.enqueueDocumentValidation()}}});const Mb=/(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,Ta=/(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,Le=/@media\s(.*)/,Ia=!(window.ShadyDOM&&window.ShadyDOM.inUse);let kb,ta;window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(ta=window.ShadyCSS.cssBuild);const cd=!(!window.ShadyCSS||!window.ShadyCSS.disableRuntime);
window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?kb=window.ShadyCSS.nativeCss:window.ShadyCSS?(fc(window.ShadyCSS),window.ShadyCSS=void 0):fc(window.WebComponents&&window.WebComponents.flags);const Db=kb,Ua=new P;window.ShadyCSS||(window.ShadyCSS={prepareTemplate(b,a,c){},prepareTemplateDom(b,a){},prepareTemplateStyles(b,a,c){},styleSubtree(b,a){Ua.processStyles();jb(b,a)},styleElement(b){Ua.processStyles()},styleDocument(b){Ua.processStyles();jb(document.body,b)},getComputedStyleValue(b,a){return ec(b,
a)},flushCustomStyles(){},nativeCss:Db,nativeShadow:Ia,cssBuild:ta,disableRuntime:cd});window.ShadyCSS.CustomStyleInterface=Ua;window.JSCompiler_renameProperty=function(b,a){return b};let ie=/(url\()([^)]*)(\))/g,he=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/,Ja,C;const Lb=!window.ShadyDOM||!window.ShadyDOM.inUse;!(window.ShadyCSS&&!window.ShadyCSS.nativeCss);const bf=Lb&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const b=new CSSStyleSheet;b.replaceSync("");const a=
document.createElement("div");a.attachShadow({mode:"open"});a.shadowRoot.adoptedStyleSheets=[b];return a.shadowRoot.adoptedStyleSheets[0]===b}catch(b){return!1}})();let cf=window.Polymer&&window.Polymer.rootPath||mb(document.baseURI||window.location.href),Ma=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,ye=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,ba=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,df=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,
xa=window.Polymer&&window.Polymer.legacyOptimizations||!1,ad=window.Polymer&&window.Polymer.legacyWarnings||!1,ef=window.Polymer&&window.Polymer.syncInitialRender||!1,ub=window.Polymer&&window.Polymer.legacyUndefined||!1,ff=window.Polymer&&window.Polymer.orderedComputed||!1,dd=window.Polymer&&window.Polymer.removeNestedTemplates||!1,ed=window.Polymer&&window.Polymer.fastDomIf||!1,Nb=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,Va=window.Polymer&&window.Polymer.legacyNoObservedAttributes||
!1,gf=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1,Aa={},Wa={};class M extends HTMLElement{static get observedAttributes(){return["id"]}static import(b,a){return b?(b=Aa[b]||Wa[b.toLowerCase()])&&a?b.querySelector(a):b:null}attributeChangedCallback(b,a,c,d){a!==c&&this.register()}get assetpath(){if(!this.__assetpath){var b=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument;b=ka(this.getAttribute("assetpath")||"",
b.baseURI);this.__assetpath=mb(b)}return this.__assetpath}register(b){if(b=b||this.id){if(ba&&void 0!==(Aa[b]||Wa[b.toLowerCase()]))throw Aa[b]=Wa[b.toLowerCase()]=null,Error(`strictTemplatePolicy: dom-module ${b} re-registered`);this.id=b;Aa[b]=Wa[b.toLowerCase()]=this;this.querySelector("style")&&console.warn("dom-module %s has style outside template",this.id)}}}M.prototype.modules=Aa;customElements.define("dom-module",M);const hf=window.ShadyCSS.CustomStyleInterface;class jf extends HTMLElement{constructor(){super();
this._style=null;hf.addCustomStyle(this)}getStyle(){if(this._style)return this._style;const b=this.querySelector("style");if(!b)return null;this._style=b;var a=b.getAttribute("include");if(a){b.removeAttribute("include");a=a.trim().split(/\s+/);var c="";for(let h=0;h<a.length;h++){{var d=void 0,e=void 0;var f=a[h];let k=M.import(f);if(k&&void 0===k._cssText){e="";d=nb(k);for(var g=0;g<d.length;g++)e+=d[g].textContent;if(g=k.querySelector("template")){d="";g=ob(g,k.assetpath);for(let l=0;l<g.length;l++){let m=
g[l];m.parentNode&&m.parentNode.removeChild(m);d+=m.textContent}e+=d}k._cssText=e||null}k||console.warn("Could not find style data in module named",f);f=k&&k._cssText||""}c+=f}a=c;b.textContent=a+b.textContent}this.ownerDocument!==window.document&&window.document.head.appendChild(this);return this._style}}window.customElements.define("custom-style",jf);const fd=document.createElement("template");fd.innerHTML='\x3ccustom-style\x3e\n  \x3cstyle\x3e\n    html {\n      /* Base (background) */\n      --lumo-base-color: #FFF;\n\n      /* Tint */\n      --lumo-tint-5pct: hsla(0, 0%, 100%, 0.3);\n      --lumo-tint-10pct: hsla(0, 0%, 100%, 0.37);\n      --lumo-tint-20pct: hsla(0, 0%, 100%, 0.44);\n      --lumo-tint-30pct: hsla(0, 0%, 100%, 0.5);\n      --lumo-tint-40pct: hsla(0, 0%, 100%, 0.57);\n      --lumo-tint-50pct: hsla(0, 0%, 100%, 0.64);\n      --lumo-tint-60pct: hsla(0, 0%, 100%, 0.7);\n      --lumo-tint-70pct: hsla(0, 0%, 100%, 0.77);\n      --lumo-tint-80pct: hsla(0, 0%, 100%, 0.84);\n      --lumo-tint-90pct: hsla(0, 0%, 100%, 0.9);\n      --lumo-tint: #FFF;\n\n      /* Shade */\n      --lumo-shade-5pct: hsla(214, 61%, 25%, 0.05);\n      --lumo-shade-10pct: hsla(214, 57%, 24%, 0.1);\n      --lumo-shade-20pct: hsla(214, 53%, 23%, 0.16);\n      --lumo-shade-30pct: hsla(214, 50%, 22%, 0.26);\n      --lumo-shade-40pct: hsla(214, 47%, 21%, 0.38);\n      --lumo-shade-50pct: hsla(214, 45%, 20%, 0.5);\n      --lumo-shade-60pct: hsla(214, 43%, 19%, 0.61);\n      --lumo-shade-70pct: hsla(214, 42%, 18%, 0.72);\n      --lumo-shade-80pct: hsla(214, 41%, 17%, 0.83);\n      --lumo-shade-90pct: hsla(214, 40%, 16%, 0.94);\n      --lumo-shade: hsl(214, 35%, 15%);\n\n      /* Contrast */\n      --lumo-contrast-5pct: var(--lumo-shade-5pct);\n      --lumo-contrast-10pct: var(--lumo-shade-10pct);\n      --lumo-contrast-20pct: var(--lumo-shade-20pct);\n      --lumo-contrast-30pct: var(--lumo-shade-30pct);\n      --lumo-contrast-40pct: var(--lumo-shade-40pct);\n      --lumo-contrast-50pct: var(--lumo-shade-50pct);\n      --lumo-contrast-60pct: var(--lumo-shade-60pct);\n      --lumo-contrast-70pct: var(--lumo-shade-70pct);\n      --lumo-contrast-80pct: var(--lumo-shade-80pct);\n      --lumo-contrast-90pct: var(--lumo-shade-90pct);\n      --lumo-contrast: var(--lumo-shade);\n\n      /* Text */\n      --lumo-header-text-color: var(--lumo-contrast);\n      --lumo-body-text-color: var(--lumo-contrast-90pct);\n      --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n      --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n      --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n      /* Primary */\n      --lumo-primary-color: hsl(214, 90%, 52%);\n      --lumo-primary-color-50pct: hsla(214, 90%, 52%, 0.5);\n      --lumo-primary-color-10pct: hsla(214, 90%, 52%, 0.1);\n      --lumo-primary-text-color: var(--lumo-primary-color);\n      --lumo-primary-contrast-color: #FFF;\n\n      /* Error */\n      --lumo-error-color: hsl(3, 100%, 61%);\n      --lumo-error-color-50pct: hsla(3, 100%, 60%, 0.5);\n      --lumo-error-color-10pct: hsla(3, 100%, 60%, 0.1);\n      --lumo-error-text-color: hsl(3, 92%, 53%);\n      --lumo-error-contrast-color: #FFF;\n\n      /* Success */\n      --lumo-success-color: hsl(145, 80%, 42%); /* hsl(144,82%,37%); */\n      --lumo-success-color-50pct: hsla(145, 76%, 44%, 0.55);\n      --lumo-success-color-10pct: hsla(145, 76%, 44%, 0.12);\n      --lumo-success-text-color: hsl(145, 100%, 32%);\n      --lumo-success-contrast-color: #FFF;\n    }\n  \x3c/style\x3e\n\x3c/custom-style\x3e\x3cdom-module id\x3d"lumo-color"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle\x3e\n      [theme~\x3d"dark"] {\n        /* Base (background) */\n        --lumo-base-color: hsl(214, 35%, 21%);\n\n        /* Tint */\n        --lumo-tint-5pct: hsla(214, 65%, 85%, 0.06);\n        --lumo-tint-10pct: hsla(214, 60%, 80%, 0.14);\n        --lumo-tint-20pct: hsla(214, 64%, 82%, 0.23);\n        --lumo-tint-30pct: hsla(214, 69%, 84%, 0.32);\n        --lumo-tint-40pct: hsla(214, 73%, 86%, 0.41);\n        --lumo-tint-50pct: hsla(214, 78%, 88%, 0.5);\n        --lumo-tint-60pct: hsla(214, 82%, 90%, 0.6);\n        --lumo-tint-70pct: hsla(214, 87%, 92%, 0.7);\n        --lumo-tint-80pct: hsla(214, 91%, 94%, 0.8);\n        --lumo-tint-90pct: hsla(214, 96%, 96%, 0.9);\n        --lumo-tint: hsl(214, 100%, 98%);\n\n        /* Shade */\n        --lumo-shade-5pct: hsla(214, 0%, 0%, 0.07);\n        --lumo-shade-10pct: hsla(214, 4%, 2%, 0.15);\n        --lumo-shade-20pct: hsla(214, 8%, 4%, 0.23);\n        --lumo-shade-30pct: hsla(214, 12%, 6%, 0.32);\n        --lumo-shade-40pct: hsla(214, 16%, 8%, 0.41);\n        --lumo-shade-50pct: hsla(214, 20%, 10%, 0.5);\n        --lumo-shade-60pct: hsla(214, 24%, 12%, 0.6);\n        --lumo-shade-70pct: hsla(214, 28%, 13%, 0.7);\n        --lumo-shade-80pct: hsla(214, 32%, 13%, 0.8);\n        --lumo-shade-90pct: hsla(214, 33%, 13%, 0.9);\n        --lumo-shade: hsl(214, 33%, 13%);\n\n        /* Contrast */\n        --lumo-contrast-5pct: var(--lumo-tint-5pct);\n        --lumo-contrast-10pct: var(--lumo-tint-10pct);\n        --lumo-contrast-20pct: var(--lumo-tint-20pct);\n        --lumo-contrast-30pct: var(--lumo-tint-30pct);\n        --lumo-contrast-40pct: var(--lumo-tint-40pct);\n        --lumo-contrast-50pct: var(--lumo-tint-50pct);\n        --lumo-contrast-60pct: var(--lumo-tint-60pct);\n        --lumo-contrast-70pct: var(--lumo-tint-70pct);\n        --lumo-contrast-80pct: var(--lumo-tint-80pct);\n        --lumo-contrast-90pct: var(--lumo-tint-90pct);\n        --lumo-contrast: var(--lumo-tint);\n\n        /* Text */\n        --lumo-header-text-color: var(--lumo-contrast);\n        --lumo-body-text-color: var(--lumo-contrast-90pct);\n        --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n        --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n        --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n        /* Primary */\n        --lumo-primary-color: hsl(214, 86%, 55%);\n        --lumo-primary-color-50pct: hsla(214, 86%, 55%, 0.5);\n        --lumo-primary-color-10pct: hsla(214, 90%, 63%, 0.1);\n        --lumo-primary-text-color: hsl(214, 100%, 70%);\n        --lumo-primary-contrast-color: #FFF;\n\n        /* Error */\n        --lumo-error-color: hsl(3, 90%, 63%);\n        --lumo-error-color-50pct: hsla(3, 90%, 63%, 0.5);\n        --lumo-error-color-10pct: hsla(3, 90%, 63%, 0.1);\n        --lumo-error-text-color: hsl(3, 100%, 67%);\n\n        /* Success */\n        --lumo-success-color: hsl(145, 65%, 42%);\n        --lumo-success-color-50pct: hsla(145, 65%, 42%, 0.5);\n        --lumo-success-color-10pct: hsla(145, 65%, 42%, 0.1);\n        --lumo-success-text-color: hsl(145, 85%, 47%);\n      }\n\n      html {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      [theme~\x3d"dark"] {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      h1,\n      h2,\n      h3,\n      h4,\n      h5,\n      h6 {\n        color: var(--lumo-header-text-color);\n      }\n\n      a {\n        color: var(--lumo-primary-text-color);\n      }\n\n      blockquote {\n        color: var(--lumo-secondary-text-color);\n      }\n\n      code,\n      pre {\n        background-color: var(--lumo-contrast-10pct);\n        border-radius: var(--lumo-border-radius-m);\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e\x3cdom-module id\x3d"lumo-color-legacy"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle include\x3d"lumo-color"\x3e\n      :host {\n        color: var(--lumo-body-text-color) !important;\n        background-color: var(--lumo-base-color) !important;\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e';
...
document.head.appendChild(kd.content);String(Math.random()).slice(2);window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:b=>b});(()=>{try{const b={get capture(){return!1}};window.addEventListener("test",b,b);window.removeEventListener("test",b,b)}catch(b){}})();"undefined"!==typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.0");"undefined"!==typeof window.ShadyCSS&&"undefined"===typeof window.ShadyCSS.prepareTemplateDom&&console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1.");
window.JSCompiler_renameProperty=(b,a)=>b;const kf=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ld=Symbol();class Ob{constructor(b,a){if(a!==ld)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=b}get styleSheet(){void 0===this._styleSheet&&(kf?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null);
return this._styleSheet}toString(){return this.cssText}}const Ba=(b,...a)=>{a=a.reduce((c,d,e)=>{if(d instanceof Ob)d=d.cssText;else if("number"!==typeof d)throw Error(`Value passed to 'css' function must be a 'css' function result: ${d}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`);return c+d+b[e+1]},b[0]);return new Ob(a,ld)};(window.litElementVersions||(window.litElementVersions=[])).push("2.5.0");let md=0;const Pb={},Ca=(b,a,c)=>{const d=c&&
c.moduleId||`custom-style-module-${md++}`;Array.isArray(a)||(a=a?[a]:[]);a.forEach(f=>{if(!(f instanceof Ob))throw Error("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`.");if(!Pb[f]){const g=document.createElement("dom-module");g.innerHTML=`\n        <template>\n          <style>${f.toString()}</style>\n        </template>\n      `;const h=`custom-style-module-${md++}`;g.register(h);Pb[f]=h}});const e=document.createElement("dom-module");if(b){const f=window.customElements&&
window.customElements.get(b);f&&f.hasOwnProperty("__finalized")&&console.warn(`The custom element definition for "${b}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`);e.setAttribute("theme-for",b)}e.innerHTML=`\n    <template>\n      ${(c&&c.include||[]).map(f=>`<style include=${f}></style>`)}\n      ${a.map(f=>`<style include=${Pb[f]}></style>`)}\n    </template>\n  `;
e.register(d)};Ca("vaadin-checkbox",Ba`
  ...
  `,{moduleId:"lumo-checkbox"});let lf=0;const D=function(b){let a=b.__mixinApplications;a||(a=new WeakMap,b.__mixinApplications=a);let c=lf++;return function(d){let e=d.__mixinSet;if(e&&e[c])return d;let f=a,g=f.get(d);g||(g=b(d),f.set(d,g),d=Object.create(g.__mixinSet||e||null),d[c]=!0,g.__mixinSet=d);return g}},q=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?b=>ShadyDOM.patch(b):b=>b,Ka={},me=/-[a-z]/g,ne=/([A-Z])/g;let mf=0,nd=0,ca=[],nf=0,
Qb=!1,od=document.createTextNode("");(new window.MutationObserver(function(){Qb=!1;const b=ca.length;for(let a=0;a<b;a++){let c=ca[a];if(c)try{c()}catch(d){setTimeout(()=>{throw d;})}}ca.splice(0,b);nd+=b})).observe(od,{characterData:!0});const G={after(b){return{run(a){return window.setTimeout(a,b)},cancel(a){window.clearTimeout(a)}}},run(b,a){return window.setTimeout(b,a)},cancel(b){window.clearTimeout(b)}},K={run(b){return window.requestAnimationFrame(b)},cancel(b){window.cancelAnimationFrame(b)}},
pd={run(b){return window.requestIdleCallback?window.requestIdleCallback(b):window.setTimeout(b,16)},cancel(b){window.cancelIdleCallback?window.cancelIdleCallback(b):window.clearTimeout(b)}},F={run(b){Qb||(Qb=!0,od.textContent=nf++);ca.push(b);return mf++},cancel(b){const a=b-nd;if(0<=a){if(!ca[a])throw Error("invalid async handle: "+b);ca[a]=null}}},of=F,qd=D(b=>{class a extends b{static createProperties(c){const d=this.prototype;for(let e in c)e in d||d._createPropertyAccessor(e)}static attributeNameForProperty(c){return c.toLowerCase()}static typeForProperty(c){}_createPropertyAccessor(c,
...
"":void 0;default:return null!=c?c.toString():void 0}}_deserializeValue(c,d){switch(d){case Boolean:return null!==c;case Number:return Number(c);default:return c}}}return a}),rd={};let Xa=HTMLElement.prototype;for(;Xa;){let b=Object.getOwnPropertyNames(Xa);for(let a=0;a<b.length;a++)rd[b[a]]=!0;Xa=Object.getPrototypeOf(Xa)}const sd=D(b=>{b=qd(b);class a extends b{static createPropertiesForAttributes(){let c=this.observedAttributes;for(let d=0;d<c.length;d++)this.prototype._createPropertyAccessor(jc(c[d]))}static attributeNameForProperty(c){return La(c)}_initializeProperties(){this.__dataProto&&
...
d)}_hasAccessor(c){return this.__dataHasAccessor&&this.__dataHasAccessor[c]}_isPropertyPending(c){return!!(this.__dataPending&&c in this.__dataPending)}}return a}),pf={"dom-if":!0,"dom-repeat":!0};let td=!1,ud=!1;const qf=D(b=>{class a extends b{static _parseTemplate(c,d){if(!c._templateInfo){let e=c._templateInfo={};e.nodeInfoList=[];e.nestedTemplate=!!d;e.stripWhiteSpace=d&&d.stripWhiteSpace||c.hasAttribute("strip-whitespace");this._parseTemplateContent(c,e,{parent:null})}return c._templateInfo}static _parseTemplateContent(c,
...
rf=/[A-Z]/,vd=(b,a,c,d,e)=>{var f=e?I(b):b;if(a=a[f])for(f=0;f<a.length;f++){var g=a[f];if(g.info.lastRun!==na&&(!e||qb(b,g.trigger))){g.info.lastRun=na;{g=g.info;var h=c,k=d;let l=0,m=h.length-1,n=-1;for(;l<=m;){const p=l+m>>1,r=k.get(h[p].methodInfo)-k.get(g.methodInfo);if(0>r)l=p+1;else if(0<r)m=p-1;else{n=p;break}}0>n&&(n=m+1);h.splice(n,0,g)}}}},ve=[],wd=/(\[\[|{{)\s*(?:(!)\s*)?((?:[a-zA-Z_$][\w.:$\-*]*)\s*(?:\(\s*(?:(?:(?:((?:[a-zA-Z_$][\w.:$\-*]*)|(?:[-+]?[0-9]*\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\]|\\.)*')|(?:"(?:[^"\\]|\\.)*")))\s*)(?:,\s*(?:((?:[a-zA-Z_$][\w.:$\-*]*)|(?:[-+]?[0-9]*\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\]|\\.)*')|(?:"(?:[^"\\]|\\.)*")))\s*))*)?)\)\s*)?)(?:]]|}})/g,
Ya=D(b=>{const a=qf(sd(b));class c extends a{constructor(){super();this.__isPropertyEffectsClient=!0;this.__dataClientsReady;this.__dataPendingClients;this.__dataToNotify;this.__dataLinkedPaths;this.__dataHasPaths;this.__dataCompoundStorage;this.__dataHost;this.__dataTemp;this.__dataClientsInitialized;this.__data;this.__dataPending;this.__dataOld;this.__computeEffects;this.__computeInfo;this.__reflectEffects;this.__notifyEffects;this.__propagateEffects;this.__observeEffects;this.__readOnly;this.__templateInfo;
...
d}}_initializeProtoProperties(d){this.__data=Object.create(d);this.__dataPending=Object.create(d);this.__dataOld={}}_initializeInstanceProperties(d){let e=this[t.READ_ONLY];for(let f in d)e&&e[f]||(this.__dataPending=this.__dataPending||{},this.__dataOld=this.__dataOld||{},this.__data[f]=this.__dataPending[f]=d[f])}_addPropertyEffect(d,e,f){this._createPropertyAccessor(d,e==t.READ_ONLY);let g=pb(this,e,!0)[d];g||(g=this[e][d]=[]);g.push(f)}_removePropertyEffect(d,e,f){d=pb(this,e,!0)[d];f=d.indexOf(f);
0<=f&&d.splice(f,1)}_hasPropertyEffect(d,e){e=this[e];return!(!e||!e[d])}_hasReadOnlyEffect(d){return this._hasPropertyEffect(d,t.READ_ONLY)}_hasNotifyEffect(d){return this._hasPropertyEffect(d,t.NOTIFY)}_hasReflectEffect(d){return this._hasPropertyEffect(d,t.REFLECT)}_hasComputedEffect(d){return this._hasPropertyEffect(d,t.COMPUTE)}_setPendingPropertyOrPath(d,e,f,g){if(g||I(Array.isArray(d)?d[0]:d)!==d){if(!g&&(g=A(this,d),d=ic(this,d,e),!d||!super._shouldPropertyChange(d,e,g)))return!1;this.__dataHasPaths=
...
e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(d,e){this._addPropertyEffect(d,t.READ_ONLY);e&&(this["_set"+xe(d)]=function(f){this._setProperty(d,f)})}_createPropertyObserver(d,e,f){let g={property:d,method:e,dynamicFn:!!f};this._addPropertyEffect(d,t.OBSERVE,{fn:lc,info:g,trigger:{name:d}});f&&this._addPropertyEffect(e,t.OBSERVE,{fn:lc,info:g,trigger:{name:e}})}_createMethodObserver(d,e){let f=tb(d);if(!f)throw Error("Malformed observer expression '"+d+"'");pc(this,f,t.OBSERVE,rb,
null,e)}_createNotifyingProperty(d){this._addPropertyEffect(d,t.NOTIFY,{fn:pe,info:{eventName:La(d)+"-changed",property:d}})}_createReflectedProperty(d){let e=this.constructor.attributeNameForProperty(d);"-"===e[0]?console.warn("Property "+d+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(d,t.REFLECT,{fn:qe,info:{attrName:e}})}_createComputedProperty(d,e,f){let g=tb(e);if(!g)throw Error("Malformed computed expression '"+
e+"'");e=pc(this,g,t.COMPUTE,nc,d,f);pb(this,"__computeInfo")[d]=e}_marshalArgs(d,e,f){const g=this.__data,h=[];for(let k=0,l=d.length;k<l;k++){let {name:m,structured:n,wildcard:p,value:r,literal:u}=d[k];if(!u)if(p){const z=0===e.indexOf(m+"."),E=rc(g,f,z?e:m);r={path:z?e:m,value:E,base:z?A(g,m):E}}else r=n?rc(g,f,m):g[m];if(ub&&!this._overrideLegacyUndefined&&void 0===r&&1<d.length)return oa;h[k]=r}return h}static addPropertyEffect(d,e,f){this.prototype._addPropertyEffect(d,e,f)}static createPropertyObserver(d,
...
this._properties[e])&&e.type}_initializeProperties(){this.constructor.finalize();super._initializeProperties()}connectedCallback(){super.connectedCallback&&super.connectedCallback();this._enableProperties()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback()}}return d}),Sb=window.ShadyCSS&&window.ShadyCSS.cssBuild,Za=D(b=>{function a(e,f,g,h){if(!Sb){const p=f.content.querySelectorAll("style"),r=ob(f);var k=le(g),l=f.content.firstElementChild;for(var m=0;m<k.length;m++){var n=
k[m];n.textContent=e._processStyleText(n.textContent,h);f.content.insertBefore(n,l)}k=0;for(l=0;l<r.length;l++)m=r[l],n=p[k],n!==m?(m=m.cloneNode(!0),n.parentNode.insertBefore(m,n)):k++,m.textContent=e._processStyleText(m.textContent,h)}window.ShadyCSS&&window.ShadyCSS.prepareTemplate(f,g);if(gf&&Sb&&bf&&(f=f.content.querySelectorAll("style"))){let p="";Array.from(f).forEach(r=>{p+=r.textContent;r.parentNode.removeChild(r)});e._styleSheet=new CSSStyleSheet;e._styleSheet.replaceSync(p)}}const c=uf(Ya(b));
...
e,f,g)}}return d}),Ea=function(b,...a){const c=document.createElement("template");c.innerHTML=a.reduce((d,e,f)=>{if(e instanceof HTMLTemplateElement)e=e.innerHTML;else throw Error(`non-template value passed to Polymer's html function: ${e}`);return d+e+b[f+1]},b[0]);return c},S=Za(HTMLElement);class v{constructor(){this._timer=this._callback=this._asyncModule=null}setConfig(b,a){this._asyncModule=b;this._callback=a;this._timer=this._asyncModule.run(()=>{this._timer=null;T.delete(this);this._callback()})}cancel(){this.isActive()&&
(this._cancelAsync(),T.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(b,a,c){b instanceof v?b._cancelAsync():b=new v;b.setConfig(a,c);return b}}let T=new Set;const vf=function(){const b=!!T.size;T.forEach(a=>{try{a.flush()}catch(c){setTimeout(()=>{throw c;})}});return b};let vb="string"===typeof document.head.style.touchAction,Na=["mousedown",
"mousemove","mouseup","click"],Ae=[0,1,4,2];try{var yd=1===(new MouseEvent("test",{buttons:1})).buttons}catch(b){yd=!1}let ze=yd,wb=!1;(function(){try{let b=Object.defineProperty({},"passive",{get(){wb=!0}});window.addEventListener("test",null,b);window.removeEventListener("test",null,b)}catch(b){}})();let vc=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const xb=[],wf={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},Ce={button:!0,command:!0,fieldset:!0,
input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};let wc=function(b){var a=b.sourceCapabilities;if(!a||a.firesTouchEvents)if(b.__polymerGesturesHandled={skip:!0},"click"===b.type){a=!1;let f=Oa(b);for(let g=0;g<f.length;g++){if(f[g].nodeType===Node.ELEMENT_NODE)if("label"===f[g].localName)xb.push(f[g]);else if(wf[f[g].localName]){var c=f[g];var d=Array.prototype.slice.call(c.labels||[]);if(!d.length){d=[];var e=c.getRootNode();if(c.id)for(c=e.querySelectorAll(`label[for = ${c.id}]`),
e=0;e<c.length;e++)d.push(c[e])}for(c=0;c<d.length;c++)a=a||-1<xb.indexOf(d[c])}if(f[g]===y.mouse.target)return}a||(b.preventDefault(),b.stopPropagation())}},y={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};document.addEventListener("touchend",function(b){y.mouse.mouseIgnoreJob||uc(!0);y.mouse.target=Oa(b)[0];y.mouse.mouseIgnoreJob=v.debounce(y.mouse.mouseIgnoreJob,G.after(2500),function(){uc();y.mouse.target=null;y.mouse.mouseIgnoreJob=null})},wb?{passive:!0}:!1);
const Oa=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:b=>b.composedPath&&b.composedPath()||[],qa={},X=[];zb({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){Z(this.info)},mousedown:function(b){if(W(b)){var a=N(b),c=this;xc(this.info,function(d){W(d)||(ra("up",a,d),Z(c.info))},function(d){W(d)&&ra("up",a,d);Z(c.info)});ra("down",a,b)}},
touchstart:function(b){ra("down",N(b),b.changedTouches[0],b)},touchend:function(b){ra("up",N(b),b.changedTouches[0],b)}});zb({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(b){2<this.moves.length&&this.moves.shift();this.moves.push(b)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start";this.info.started=
!1;this.info.moves=[];this.info.x=0;this.info.y=0;this.info.prevent=!1;Z(this.info)},mousedown:function(b){if(W(b)){var a=N(b),c=this,d=function(e){let f=e.clientX,g=e.clientY;Ac(c.info,f,g)&&(c.info.state=c.info.started?"mouseup"===e.type?"end":"track":"start","start"===c.info.state&&Pa("tap"),c.info.addMove({x:f,y:g}),W(e)||(c.info.state="end",Z(c.info)),a&&Bb(c.info,a,e),c.info.started=!0)};xc(this.info,d,function(e){c.info.started&&d(e);Z(c.info)});this.info.x=b.clientX;this.info.y=b.clientY}},
touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchmove:function(b){let a=N(b);b=b.changedTouches[0];let c=b.clientX,d=b.clientY;Ac(this.info,c,d)&&("start"===this.info.state&&Pa("tap"),this.info.addMove({x:c,y:d}),Bb(this.info,a,b),this.info.state="track",this.info.started=!0)},touchend:function(b){let a=N(b);b=b.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:b.clientX,y:b.clientY}),Bb(this.info,a,b))}});zb({name:"tap",
deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN;this.info.y=NaN;this.info.prevent=!1},mousedown:function(b){W(b)&&(this.info.x=b.clientX,this.info.y=b.clientY)},click:function(b){W(b)&&Bc(this.info,b)},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchend:function(b){Bc(this.info,b.changedTouches[0],b)}});const Fa=
...
this._setFocused(!1)}_setFocused(a){a?this.setAttribute("focused",""):this.removeAttribute("focused");a&&Ub?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`);return this}_focus(){this.focusElement&&!this._isShiftTabbing&&(this.focusElement.focus(),this._setFocused(!0))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&
...
d;break;case "reverse":c.scrollLeft=c.scrollWidth-c.clientWidth-d;break;default:c.scrollLeft=d}else c.scrollLeft=d}}const U=[];let $a;(new MutationObserver(function(){const b=ea();U.forEach(a=>{Wb(a,b)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Wb=function(b,a){a?b.setAttribute("dir",a):b.removeAttribute("dir")},ea=function(){return document.documentElement.getAttribute("dir")},Xb=b=>class extends b{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize();
$a||($a=Vb.detectScrollType())}connectedCallback(){super.connectedCallback();this.hasAttribute("dir")||(this.__subscribe(),Wb(this,ea()))}attributeChangedCallback(a,c,d){super.attributeChangedCallback(a,c,d);if("dir"===a){a=d===ea()&&-1===U.indexOf(this);var e=!d&&c&&-1===U.indexOf(this);c=d!==ea()&&c===ea();a||e?(this.__subscribe(),Wb(this,ea())):c&&this.__subscribe(!1)}}disconnectedCallback(){super.disconnectedCallback();this.__subscribe(!1);this.removeAttribute("dir")}__subscribe(a=!0){a?-1===
U.indexOf(this)&&U.push(this):-1<U.indexOf(this)&&U.splice(U.indexOf(this),1)}__getNormalizedScrollLeft(a){return Vb.getNormalizedScrollLeft($a,this.getAttribute("dir")||"ltr",a)}__setNormalizedScrollLeft(a,c){return Vb.setNormalizedScrollLeft($a,this.getAttribute("dir")||"ltr",a,c)}},Fe=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Qa=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;window.Vaadin=window.Vaadin||{};const zd=function(b,a){if(window.Vaadin.developmentMode)return Cc(b,
a)};if(void 0===window.Vaadin.developmentMode){var Af=window.Vaadin;try{var Ad=localStorage.getItem("vaadin.developmentmode.force")?!0:0<=["localhost","127.0.0.1"].indexOf(window.location.hostname)?Qa?!Ee():!De():!1}catch(b){Ad=!1}Af.developmentMode=Ad}const Bd=function(){if("function"===typeof zd)return zd(Ge)};window.Vaadin||(window.Vaadin={});window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{};window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=
function(){Bd&&Bd()};let Yb;const Cd=new Set,Dd=b=>class extends Xb(b){static finalize(){super.finalize();const {is:a}=this;a&&!Cd.has(a)&&(window.Vaadin.registrations.push(this),Cd.add(a),window.Vaadin.developmentModeCallback&&(Yb=v.debounce(Yb,pd,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),T.add(Yb)))}constructor(){super();null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add \x3c!DOCTYPE html\x3e to the HTML document.')}};
class Ed extends Dd(zf(Tb(Fa(S)))){static get template(){return Ea`
      <style>
        :host {
          display: inline-block;
        }
...
"a"===b.target.localName?!1:!0}_handleClick(b){this.__interactionsAllowed(b)&&(this.indeterminate?(this.indeterminate=!1,b.preventDefault(),this._toggleChecked()):b.composedPath()[0]!==this._nativeCheckbox&&(b.preventDefault(),this._toggleChecked()))}_toggleChecked(){this.checked=!this.checked;this.dispatchEvent(new CustomEvent("change",{composed:!1,bubbles:!0}))}}customElements.define(Ed.is,Ed);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-select-all-checkbox-lumo"});let Ra=!1,Ec=[],Fc=[];class Ic{constructor(){this.end=this.start=0;this.rules=this.parent=this.previous=null;this.cssText=this.parsedCssText="";this.atRule=!1;this.type=0;this.parsedSelector=this.selector=this.keyframesName=""}}const O={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1E3},J={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},Fd=new Set;window.ShadyDOM&&window.ShadyDOM.wrap||(b=>b);const Bf=/;\s*/m,Cf=/^\s*(initial)|(inherit)\s*$/,Gd=/\s*!important/;class Df{constructor(){this._map={}}set(b,a){b=b.trim();this._map[b]={properties:a,dependants:{}}}get(b){b=b.trim();return this._map[b]||null}}let ab=null;class B{constructor(){this._measureElement=this._currentElement=
null;this._map=new Df}detectMixin(b){b=Ta.test(b)||Mb.test(b);Ta.lastIndex=0;Mb.lastIndex=0;return b}gatherStyles(b){var a=[];var c=b.content.querySelectorAll("style");for(let d=0;d<c.length;d++){const e=c[d];if(e.hasAttribute("shady-unscoped")){if(!Ia){{const f=e.textContent;if(!Fd.has(f)){Fd.add(f);const g=document.createElement("style");g.setAttribute("shady-unscoped","");g.textContent=f;document.head.appendChild(g)}}e.parentNode.removeChild(e)}}else a.push(e.textContent),e.parentNode.removeChild(e)}return(a=
a.join("").trim())?(c=document.createElement("style"),c.textContent=a,b.content.insertBefore(c,b.content.firstChild),c):null}transformTemplate(b,a){void 0===b._gatheredStyle&&(b._gatheredStyle=this.gatherStyles(b));return(b=b._gatheredStyle)?this.transformStyle(b,a):null}transformStyle(b,a=""){let c=Lc(b);this.transformRules(c,a);b.textContent=Cb(c);return c}transformCustomStyle(b){let a=Lc(b);sa(a,c=>{":root"===c.selector&&(c.selector="html");this.transformRule(c)});b.textContent=Cb(a);return a}transformRules(b,
a){this._currentElement=a;sa(b,c=>{this.transformRule(c)});this._currentElement=null}transformRule(b){b.cssText=this.transformCssText(b.parsedCssText,b);":root"===b.selector&&(b.selector=":host \x3e *")}transformCssText(b,a){b=b.replace(Mb,(c,d,e,f)=>this._produceCssProperties(c,d,e,f,a));return this._consumeCssProperties(b,a)}_getInitialValueForProperty(b){this._measureElement||(this._measureElement=document.createElement("meta"),this._measureElement.setAttribute("apply-shim-measure",""),this._measureElement.style.all=
...
B.prototype.transformCustomStyle=B.prototype.transformCustomStyle;B.prototype.transformRules=B.prototype.transformRules;B.prototype.transformRule=B.prototype.transformRule;B.prototype.transformTemplate=B.prototype.transformTemplate;B.prototype._separator="_-_";Object.defineProperty(B.prototype,"invalidCallback",{get(){return ab},set(b){ab=b}});const Eb={},Oe=Promise.resolve(),Ga=new B;class Ef{constructor(){this.customStyleInterface=null;Ga.invalidCallback=Me}ensure(){!this.customStyleInterface&&
window.ShadyCSS.CustomStyleInterface&&(this.customStyleInterface=window.ShadyCSS.CustomStyleInterface,this.customStyleInterface.transformCallback=b=>{Ga.transformCustomStyle(b)},this.customStyleInterface.validateCallback=()=>{requestAnimationFrame(()=>{this.customStyleInterface.enqueued&&this.flushCustomStyles()})})}prepareTemplate(b,a){this.ensure();""===Nc(b)&&(Eb[a]=b,a=Ga.transformTemplate(b,a),b._styleAst=a)}flushCustomStyles(){this.ensure();if(this.customStyleInterface){var b=this.customStyleInterface.processStyles();
if(this.customStyleInterface.enqueued){for(let a=0;a<b.length;a++){let c=this.customStyleInterface.getStyleForCustomStyle(b[a]);c&&Ga.transformCustomStyle(c)}this.customStyleInterface.enqueued=!1}}}styleSubtree(b,a){this.ensure();a&&jb(b,a);if(b.shadowRoot)for(this.styleElement(b),b=b.shadowRoot.children||b.shadowRoot.childNodes,a=0;a<b.length;a++)this.styleSubtree(b[a]);else for(b=b.children||b.childNodes,a=0;a<b.length;a++)this.styleSubtree(b[a])}styleElement(b){this.ensure();{var a=b.localName;
var c="";let d="";a?-1<a.indexOf("-")?c=a:(d=a,c=b.getAttribute&&b.getAttribute("is")||""):(c=b.is,d=b.extends);a={is:c,typeExtension:d}}({is:c}=a);a=Eb[c];if((!a||""===Nc(a))&&a&&!Oc(a)){if(Oc(a)||a._applyShimValidatingVersion!==a._applyShimNextVersion)this.prepareTemplate(a,c),Ne(a);if(b=b.shadowRoot)if(b=b.querySelector("style"))b.__cssRules=a._styleAst,b.textContent=Cb(a._styleAst)}}styleDocument(b){this.ensure();this.styleSubtree(document.body,b)}}if(!window.ShadyCSS||!window.ShadyCSS.ScopingShim){const b=
...
nativeCss:Db,nativeShadow:Ia,cssBuild:ta,disableRuntime:cd};a&&(window.ShadyCSS.CustomStyleInterface=a)}window.ShadyCSS.ApplyShim=Ga;const Ff=/:host\(:dir\((ltr|rtl)\)\)/g,Gf=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Hf=/:dir\((?:ltr|rtl)\)/,Hd=!(!window.ShadyDOM||!window.ShadyDOM.inUse),va=[];let Ha=null,ua="";const If=D(b=>{Hd||Ha||(ua=document.documentElement.getAttribute("dir"),Ha=new MutationObserver(Pc),Ha.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const a=sd(b);
class c extends a{static _processStyleText(d,e){d=a._processStyleText.call(this,d,e);!Hd&&Hf.test(d)&&(d=this._replaceDirInCssText(d),this.__activateDir=!0);return d}static _replaceDirInCssText(d){d=d.replace(Ff,':host([dir\x3d"$1"])');return d=d.replace(Gf,':host([dir\x3d"$2"]) $1')}constructor(){super();this.__autoDirOptOut=!1}ready(){super.ready();this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){a.prototype.connectedCallback&&super.connectedCallback();this.constructor.__activateDir&&
(Ha&&Ha.takeRecords().length&&Pc(),va.push(this),this.__autoDirOptOut||this.setAttribute("dir",ua))}disconnectedCallback(){a.prototype.disconnectedCallback&&super.disconnectedCallback();if(this.constructor.__activateDir){const d=va.indexOf(this);-1<d&&va.splice(d,1)}}}c.__activateDir=!1;return c});"interactive"===document.readyState||"complete"===document.readyState?Qc():window.addEventListener("DOMContentLoaded",Qc);let Y=class{static getFlattenedNodes(b){const a=q(b);return aa(b)?a.assignedNodes({flatten:!0}):
...
g=f+g;let k=h&&h[g];k&&(this._removeEventListenerFromNode(e,f,k),h[g]=null)}setScrollDirection(e,f){zc(f||this,c[e]||"auto")}$$(e){return this.root.querySelector(e)}get domHost(){let e=q(this).getRootNode();return e instanceof DocumentFragment?e.host:e}distributeContent(){const e=V(this);window.ShadyDOM&&e.shadowRoot&&ShadyDOM.flush()}getEffectiveChildNodes(){return V(this).getEffectiveChildNodes()}queryDistributedElements(e){return V(this).queryDistributedElements(e)}getEffectiveChildren(){return this.getEffectiveChildNodes().filter(function(e){return e.nodeType===
Node.ELEMENT_NODE})}getEffectiveTextContent(){let e=this.getEffectiveChildNodes(),f=[];for(let g=0,h;h=e[g];g++)h.nodeType!==Node.COMMENT_NODE&&f.push(h.textContent);return f.join("")}queryEffectiveChildren(e){return(e=this.queryDistributedElements(e))&&e[0]}queryAllEffectiveChildren(e){return this.queryDistributedElements(e)}getContentChildNodes(e){return(e=this.root.querySelector(e||"slot"))?V(e).getDistributedNodes():[]}getContentChildren(e){return this.getContentChildNodes(e).filter(function(f){return f.nodeType===
...
return!(!e||!e.isActive())}flushDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.flush()}cancelDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.cancel()}async(e,f){return 0<f?G.run(e.bind(this),f):~F.run(e.bind(this))}cancelAsync(e){0>e?F.cancel(~e):G.cancel(e)}create(e,f){e=document.createElement(e);if(f)if(e.setProperties)e.setProperties(f);else for(let g in f)e[g]=f[g];return e}elementMatches(e,f){return Id.call(f||this,e)}toggleAttribute(e,
...
hostAttributes:!0},Xc={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,behaviors:!0,_noAccessors:!0},Ve=Object.assign({listeners:!0,hostAttributes:!0,properties:!0,observers:!0},Xc),Ld=Kd(HTMLElement),ac=D(b=>{class a extends b{_shouldPropertyChange(c,d,e){return Gb(this,c,d,e,!0)}}return a}),Md=D(b=>{class a extends b{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(c,d,e){return Gb(this,c,d,e,this.mutableData)}}return a});
ac._mutablePropertyChange=Gb;let Ib=null;Hb.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:Hb,writable:!0}});const $c=Ya(Hb),$e=ac($c),Kf=Ya(class{});class Jb extends Kf{constructor(b){super();this._configureProperties(b);this.root=this._stampTemplate(this.__dataHost);var a=[];this.children=a;for(let c=this.root.firstChild;c;c=c.nextSibling)a.push(c),c.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);
...
const Ze=ac(Jb);let bd=!1;const Lf=Fa(Md(Ya(HTMLElement)));class Mf extends Lf{static get observedAttributes(){return["mutable-data"]}constructor(){super();if(ba)throw Error("strictTemplatePolicy: dom-bind not allowed");this.__children=this.$=this.root=null}attributeChangedCallback(b,a,c,d){this.mutableData=!0}connectedCallback(){Kb()||(this.style.display="none");this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){q(q(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let b=
...
a;this._enableProperties()}this.__insertChildren();this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}customElements.define("dom-bind",Mf);const Nf=Md(S);class Nd extends Nf{static get is(){return"dom-repeat"}static get template(){return null}static get properties(){return{items:{type:Array},as:{type:String,value:"item"},indexAs:{type:String,value:"index"},itemsIndexAs:{type:String,value:"itemsIndex"},sort:{type:Function,observer:"__sortChanged"},filter:{type:Function,observer:"__filterChanged"},
observe:{type:String,observer:"__observeChanged"},delay:Number,renderedItemCount:{type:Number,notify:!Nb,readOnly:!0},initialCount:{type:Number},targetFramerate:{type:Number,value:20},_targetFrameTime:{type:Number,computed:"__computeFrameTime(targetFramerate)"},notifyDomChange:{type:Boolean},reuseChunkedInstances:{type:Boolean}}}static get observers(){return["__itemsChanged(items.*)"]}constructor(){super();this.__instances=[];this.__renderDebouncer=null;this.__itemsIdxToInstIdx={};this.__renderStartTime=
this.__chunkCount=null;this.__shouldContinueChunking=this.__shouldMeasureChunk=this.__itemsArrayChanged=!1;this.__chunkingId=0;this.__ctor=this.__observePaths=this.__filterFn=this.__sortFn=null;this.__isDetached=!0;this.template=null;this._templateInfo}disconnectedCallback(){super.disconnectedCallback();this.__isDetached=!0;for(let b=0;b<this.__instances.length;b++)this.__detachInstance(b)}connectedCallback(){super.connectedCallback();Kb()||(this.style.display="none");if(this.__isDetached){this.__isDetached=
...
this.__teardownInstance();this._showHideChildren();Nb&&!this.notifyDomChange||this.if==this._lastIf||(this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0})),this._lastIf=this.if)}__hasInstance(){}__getInstanceNodes(){}__createAndInsertInstance(b){}__teardownInstance(){}_showHideChildren(){}}class Of extends Od{constructor(){super();this.__syncInfo=this.__instance=null}__hasInstance(){return!!this.__instance}__getInstanceNodes(){return this.__instance.templateInfo.childNodes}__createAndInsertInstance(b){const a=
...
!this.if;this.__instance&&!!this.__instance.__hidden!==b&&(this.__instance.__hidden=b,this.__instance._showHideChildren(b));b||this.__syncHostProperties()}}const Pd=ed?Of:Pf;customElements.define(Pd.is,Pd);let Qf=D(b=>{b=Za(b);class a extends b{static get properties(){return{items:{type:Array},multi:{type:Boolean,value:!1},selected:{type:Object,notify:!0},selectedItem:{type:Object,notify:!0},toggle:{type:Boolean,value:!1}}}static get observers(){return["__updateSelection(multi, items.*)"]}constructor(){super();
...
this.__selectedMap.clear(),this.__selectedMap.set(d,c),this.__updateLinks(),this.multi?this.push("selected",d):this.selected=this.selectedItem=d)}}return a})(S);class Qd extends Qf{static get is(){return"array-selector"}static get template(){return null}}customElements.define(Qd.is,Qd);const ia=Kd(HTMLElement).prototype;var bb=new Set;const Rf={properties:{_parentResizable:{type:Object,observer:"_parentResizableChanged"},_notifyingDescendant:{type:Boolean,value:!1}},listeners:{"iron-request-resize-notifications":"_onIronRequestResizeNotifications"},
...
(a.removeEventListener("scroll",this._boundScrollHandler),this._boundScrollHandler=null)},toggleScrollListener:function(b){this._shouldHaveListener=b;this._toggleScrollListener(b,this.scrollTarget)}},Rd=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Tf=Rd&&8<=Rd[1],Uf=function(b,a){b||console.warn("Polymer.Class requires `info` argument");a=a?a(Ld):Ld;a=Ue(b,a,b.behaviors);a.is=a.prototype.is=b.is;return a}({behaviors:[Rf,Sf],_ratio:.5,_scrollerPaddingTop:0,_scrollPosition:0,_physicalSize:0,
...
e-1);a-=f.effectiveSize}return{cache:this,scaledIndex:a}}},ag=b=>class extends b{static get properties(){return{pageSize:{type:Number,value:50,observer:"_pageSizeChanged"},dataProvider:{type:Object,notify:!0,observer:"_dataProviderChanged"},loading:{type:Boolean,notify:!0,readOnly:!0,reflectToAttribute:!0},_cache:{type:Object,value:function(){return new Sd(this)}},itemIdPath:{type:String,value:null},expandedItems:{type:Object,notify:!0,value:()=>[]}}}static get observers(){return["_sizeChanged(size)",
...
value:a.value}))}};class cb extends S{static get is(){return"vaadin-grid-templatizer"}static get properties(){return{dataHost:Object,template:Object,_templateInstances:{type:Array,value:function(){return[]}},_parentPathValues:{value:function(){return{}}},_grid:Object}}static get observers(){return["_templateInstancesChanged(_templateInstances.*, _parentPathValues.*)"]}constructor(){super();this._instanceProps={detailsOpened:!0,index:!0,item:!0,selected:!0,expanded:!0,level:!0}}createInstance(){this._ensureTemplatized();
...
this._previousHidden=a}};class db extends mg(Xb(S)){static get is(){return"vaadin-grid-column"}static get properties(){return{width:{type:String,value:"100px"},flexGrow:{type:Number,value:1},renderer:Function,path:{type:String},autoWidth:{type:Boolean,value:!1},_bodyTemplate:{type:Object},_cells:Array}}}customElements.define(db.is,db);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-styles"});try{document.createEvent("TouchEvent");var Td=!0}catch(b){Td=!1}const ng=Td;class Ud extends Dd(Tb(ag(Zf(bg(Yf(fg(gg(hg(eg(kg(Wf(dg(lg($f(cg(jg(ig(Vf)))))))))))))))))){static get template(){return Ea`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
...
setTimeout(()=>this.$.scroller.style.overflow="")})}}customElements.define(Ud.is,Ud);class Vd extends db{static get template(){return Ea`
...
!Array.isArray(this._grid.items)}}customElements.define(Vd.is,Vd);Ca("vaadin-grid-sorter",Ba`
    :host {
...
"asc"===this.direction?"desc":"desc"===this.direction?null:"asc")}}customElements.define(Xd.is,Xd);class Yd extends db{static get template(){return Ea`
      <template class="header" id="headerTemplate">
        <vaadin-grid-sorter path="[[path]]" direction="{{direction}}">[[_getHeader(header, path)]]</vaadin-grid-sorter>
      </template>
    `}static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}_prepareHeaderTemplate(){const b=this._prepareTemplatizer(this.$.headerTemplate);b.templatizer.dataHost=this;return b}_getHeader(b,a){return b||this._generateHeader(a)}}customElements.define(Yd.is,Yd);const Zd={selectionColumn:!0,columnMenus:!0};let w=function(b){function a(d,e){d=b.call(this,d,e)||this;d._grid=null;d._headerStyles="display: flex; font-weight: 400;";
...
d.viewModel=new ee;d.visibleElements={...Zd};return d}eb._inheritsLoose(a,b);var c=a.prototype;c.initialize=function(){this.handles.add([this.columns.on("change",()=>this._syncColumnRenderers()),gb.watch(this,"viewModel.size",()=>this._updateGridSize()),gb.watch(this,"store.state",(d,e)=>{"ready"!==d||"loaded"!==e&&"error"!==e||this.refreshPageCache()}),gb.on(this,"_grid.$.table","scroll",()=>{var d;null==(d=this.viewModel)?void 0:d.closeColumnMenus()})])};c.destroy=function(){var d;this.handles.removeAll();
this.resetColumns();null==(d=this.columns)?void 0:d.destroy()};c.resetColumns=function(){this.columns.items.forEach(d=>d.destroy());this.columns.removeAll()};c.castVisibleElements=function(d){return{...Zd,...d}};c.render=function(){const {columnMenus:d}=this.visibleElements;return ja.tsx("div",{bind:this,class:this.classes("esri-grid","esri-widget",{["esri-grid--no-column-menu"]:!d})},ja.tsx("div",{bind:this,class:"esri-grid__content"},this.renderGrid()))};c.renderGrid=function(){return ja.tsx("vaadin-grid",
{...this.getGridProps()},this.renderAllColumns())};c.renderAllColumns=function(){if("disabled"!==this.viewModel.state&&this.columns&&this.columns.length)return[this.renderSelectionColumn(),this.renderColumns()]};c.renderSelectionColumn=function(){return ja.tsx("vaadin-grid-selection-column",{_selectAllHidden:!0,selectAll:!1,bind:this,hidden:!this.visibleElements.selectionColumn,sortable:!1,frozen:!fe.isRTL(this.container)})};c.renderColumns=function(){return this.columns.items.map((d,e)=>ja.tsx("vaadin-grid-column",
{...this.getColumnProps(d,e)}))};c.getGridProps=function(){const {columnReorderingEnabled:d,id:e,multiSortEnabled:f,pageSize:g,size:h}=this;return{_safari:!1,class:"esri-grid__grid",id:`${e}_grid`,theme:"compact column-borders",ref:"grid",bind:this,afterCreate:this._afterGridCreate,afterUpdate:this._afterGridUpdate,columnReorderingAllowed:d,pageSize:g,size:h,multiSort:f}};c.getColumnProps=function(d,e){const {id:f}=this,{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,path:p,resizable:r,
textAlign:u,width:z}=d;d=`${f}_${m}_${bc.isSome(e)?e:p}`;return{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,key:d,path:p,resizable:r,"text-align":u,width:"number"===typeof z?`${z}px`:z,bind:this,afterCreate:this._afterColumnCreate,afterRemoved:this._afterColumnRemoved}};c.clearSelection=function(){this._clearSelection();this.scheduleRender()};c.clearSort=function(){var d,e;let f=!1;this._grid&&(null!=(d=this._grid._sorters)&&d.length&&(this._grid._sorters.forEach(g=>{g._order=null;
g.direction=null}),f=!0),null!=(e=this.columns)&&e.length&&this.columns.find(g=>!!g.direction)&&(this.columns.forEach(g=>g.direction=null),f=!0),f&&(this.notifyChange("sortOrders"),this.scheduleRender()))};c.deselectItem=function(d){this._deselectRowByItem(d)};c.deselectRow=function(d){(d=this.viewModel.getRowItemAt(d))&&this._deselectRowByItem(d)};c.findColumn=function(){};c.generateCellClassNames=function(){var d;null==(d=this._grid)?void 0:d.generateCellClassNames()};c.getSlotElementByName=function(d){var e,
f;return null==(e=this._grid)?void 0:null==(f=e.shadowRoot)?void 0:f.querySelector(`slot[name='${d}']`)};c.hideColumn=function(d){var e;null==(e=this.viewModel)?void 0:e.hideColumn(d);this.scheduleRender()};c.notifyResize=function(){var d;null==(d=this._grid)?void 0:d.notifyResize()};c.recalculateColumnWidths=function(){var d;null==(d=this._grid)?void 0:d.recalculateColumnWidths()};c.reset=function(){var d=eb._asyncToGenerator(function*(){var e;this._clearSelection();yield null==(e=this.store)?void 0:
e.reset();this.scrollToTop()});return function(){return d.apply(this,arguments)}}();c.refreshPageCache=function(){var d;null==(d=this._grid)?void 0:d.clearCache()};c.selectRows=function(d){const e=this._grid.selectedItems.slice();d.forEach(f=>{0>e.findIndex(g=>g.objectId===f.objectId)&&this._grid.selectedItems.push(f)});this._updateSelectionProps();this._grid.render()};c.deselectRows=function(d){const e=this._grid.selectedItems.slice();d.forEach(f=>{const g=e.findIndex(h=>h.objectId===f.objectId);
-1<g&&e.splice(g,1)});this._grid.selectedItems=e;this._updateSelectionProps();this._grid.render()};c.selectItem=function(d){this._selectRowByItem(d)};c.selectRow=function(d){(d=this.viewModel.getRowItemAt(d))&&this._selectRowByItem(d)};c.showColumn=function(d){var e;null==(e=this.viewModel)?void 0:e.showColumn(d);this.scheduleRender()};c.sort=function({path:d,direction:e}){var f;null==(f=this.viewModel)?void 0:f.sortColumn(d,e);this.notifyChange("sortOrders")};c.scrollToIndex=function(d){var e;null==
(e=this._grid)?void 0:e.scrollToIndex(d)};c.scrollToTop=function(){var d;null==(d=this._grid)?void 0:d.scrollToIndex(0)};c.isEditingActive=function(){return!!this._getActiveEditInfo().length};c.getSelectedRowIds=function(){return this.selectedItems.map(d=>d.objectId).toArray()};c._afterGridCreate=function(d){const {cellClassNameGenerator:e,dataProvider:f,itemIdPath:g,rowDetailsRenderer:h}=this;d.cellClassNameGenerator=e;d.dataProvider=f;d.rowDetailsRenderer=h;d.itemIdPath=g;this._grid=d;customElements.whenDefined("vaadin-grid").then(()=>
{this._appendStyles();this._addGridEventListeners()});this._grid.__updateSorter=k=>{const l=this._grid;var m=l._sorters;const n=-1===m.indexOf(k);if(k.direction||!n)k._order=null,l.multiSort?(l._removeArrayItem(m,k),k.direction&&(bc.isSome(k._initialOrder)?(n?m[k._initialOrder]=k:m.splice(k._initialOrder,0,k),k._initialOrder=null):m.unshift(k)),l.__updateSortOrders()):k.direction&&(m=m.filter(p=>p!==k),l._sorters=[k],m.forEach(p=>{p._order=null;p.direction=null}))}};c._afterGridUpdate=function(d){this._grid||
...
null==e?void 0:e.appendChild(d)};c._updateGridSize=function(){this._grid&&(this._grid.size=this.size||0,this.scheduleRender())};c._getActiveEditInfo=function(){return!this.columns||this.columns.length?[]:this.columns.filter(d=>"activeEditInfo"in d).map(d=>d.activeEditInfo).items};c._addGridEventListeners=function(){const {_grid:d}=this;this.handles.add([fb.on(d,"click",e=>this._onRowClick(e)),fb.on(d,"selected-items-changed",e=>this._onSelectionChange(e)),fb.on(d,"sorter-changed",()=>this.notifyChange("sortOrders"))])};
...
column:h,rowData:k})),f.footerRenderFunction&&(d.footerRenderer=(g,h)=>f.footerRenderFunction({root:g,column:h})),f.headerRenderFunction&&(d.headerRenderer=(g,h)=>f.headerRenderFunction({root:g,column:h}))}catch(g){}};eb._createClass(a,[{key:"sortOrders",get:function(){return this._grid._sorters.filter(d=>!!d).map(({direction:d,path:e})=>({direction:d,path:e}))}}]);return a}(ae.HandleOwnerMixin(de));x.__decorate([L.property()],w.prototype,"_grid",void 0);x.__decorate([H.aliasOf("viewModel.cellClassNameGenerator")],
w.prototype,"cellClassNameGenerator",void 0);x.__decorate([H.aliasOf("viewModel.columns")],w.prototype,"columns",void 0);x.__decorate([H.aliasOf("viewModel.columnReorderingEnabled")],w.prototype,"columnReorderingEnabled",void 0);x.__decorate([H.aliasOf("viewModel.dataProvider")],w.prototype,"dataProvider",void 0);x.__decorate([L.property()],w.prototype,"itemIdPath",void 0);x.__decorate([L.property({aliasOf:{source:"messages.widgetLabel",overridable:!0}})],w.prototype,"label",void 0);x.__decorate([L.property(),
ge.messageBundle("esri/widgets/FeatureTable/t9n/FeatureTable")],w.prototype,"messages",void 0);x.__decorate([H.aliasOf("viewModel.multiSortEnabled")],w.prototype,"multiSortEnabled",void 0);x.__decorate([H.aliasOf("viewModel.pageSize")],w.prototype,"pageSize",void 0);x.__decorate([H.aliasOf("viewModel.rowDetailsRenderer")],w.prototype,"rowDetailsRenderer",void 0);x.__decorate([L.property({readOnly:!0})],w.prototype,"selectedItems",void 0);x.__decorate([H.aliasOf("viewModel.size")],w.prototype,"size",
void 0);x.__decorate([L.property({readOnly:!0})],w.prototype,"sortOrders",null);x.__decorate([H.aliasOf("viewModel.store")],w.prototype,"store",void 0);x.__decorate([L.property()],w.prototype,"viewModel",void 0);x.__decorate([L.property()],w.prototype,"visibleElements",void 0);x.__decorate([be.cast("visibleElements")],w.prototype,"castVisibleElements",null);x.__decorate([H.aliasOf("viewModel.findColumn")],w.prototype,"findColumn",null);return w=x.__decorate([ce.subclass("esri.widgets.FeatureTable.Grid.Grid")],
w)});