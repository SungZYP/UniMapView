...
//>>built
define(["exports","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder"],function(c,e,a,f){function d(){const b=new f.ShaderBuilder;b.include(e.ScreenSpacePass,!1);b.fragment.uniforms.add("tileRows","float").add("tileSize","float");b.fragment.code.add(a.glsl`
  ...
  `);b.fragment.code.add(a.glsl`void main() {
float padWidth = 1.0;
...
}`);return b}const g=Object.freeze({__proto__:null,build:d});c.NoiseTextureAtlasShader=g;c.build=d});